package CollaborationURLGenerator;
...
sub new {
    ...
    $self->{levier} = 'Collaboration'; # Définit le nom du canal
    return $self;
}


# Valide les paramètres pour le levier Collaboration
...
# Génère les URLs pour le levier Collaboration
sub generer_urls {
    my ($self, $params) = @_;
...
# Traite le CSV pour le levier Collaboration
sub process_csv {
    my ($self) = @_;
